...
// Usage in XML: <part Name="Sibs_ModifyReputation" Faction="Tortoises" Value="100" Faction2="Issachari" Value2="-100" Shown="True" />
...
{
    public class Sibs_ModifyReputation : IConversationPart
    {
